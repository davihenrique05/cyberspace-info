...
class TecnologiasUsadasAdapter(private val tecnologias: List<ProjectDataModel>, val listener: (ProjectDataModel) -> Unit): RecyclerView.Adapter<TecnologiasUsadasAdapter.TecnologiasUsadasViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TecnologiasUsadasViewHolder {
