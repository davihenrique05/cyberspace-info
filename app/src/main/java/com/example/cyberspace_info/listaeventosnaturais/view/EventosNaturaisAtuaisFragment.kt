 ...
 * Use the [EventosNaturaisAtuaisFragment.newInstance] factory method to
...
class EventosNaturaisAtuaisFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EventosNaturaisAtuaisFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EventosNaturaisAtuaisFragment()
                .apply {
